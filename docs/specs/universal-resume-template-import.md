...
- Style token candidate lists are inferred for colors, typography roles, section
  spacing, and divider widths; name, body, section-heading, and metadata
  typography candidates can be selected from review where present.
...
- Style token candidate selection currently covers colors, name typography, body
  typography, section-heading typography, metadata typography, section spacing,
  divider widths, and layout controls; richer review controls for entry-title
