...
type SubTab = "calculator" | "compare" | "negotiate";

export function SalaryResearchPane() {
...
${script.close}
  ...
  const tabs = [
    {
      id: "calculator" as SubTab,
      label: "Salary Calculator",
      icon: Calculator,
    },
    { id: "compare" as SubTab, label: "Compare Offers", icon: BarChart3 },
    { id: "negotiate" as SubTab, label: "Negotiate", icon: TrendingUp },
  ];
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-xl bg-muted/50">
                  <p className="text-sm text-muted-foreground">
                    ...
                    {formatCurrency(salaryRange.median)}) as a baseline, and the
                    75th percentile ({formatCurrency(salaryRange.percentile75)})
                    if you have strong skills or competing offers.
                  </p>
                </div>
              </div>
            </PagePanel>
                ...
                {offers.map((offer) => (
                  ...
                  >
                    ...
                    <div className="mt-3 space-y-1 text-sm">
                      ...
                      {offer.equityValue && (
                        <p>Equity: {formatCurrency(offer.equityValue)} (4yr)</p>
                      )}
                    </div>
                    {comparison && (
            ...
            {script ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-muted-foreground">
                  Enter offer details to generate your personalized negotiation
                  script
                </p>
              </div>
            )}
