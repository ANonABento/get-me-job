...
function BulkSourceCard(props) {
    const { sourceLabel, detectedCount, busy, progress, lastResult, lastError, onScrapeVisible, onScrapePaginated, onCancel, onViewTracker, limits, onOpenOptions, } = props;
    ...
    return ((0,jsx_runtime.jsxs)("article", { className: "card bulk-source", "data-bulk-source": sourceLabel.toLowerCase(), children: [(0,jsx_runtime.jsxs)("header", { className: "bulk-source-head", children: [(0,jsx_runtime.jsx)("span", { className: "card-title", children: sourceLabel }), (0,jsx_runtime.jsxs)("span", { className: "badge", children: [detectedCount, " row", detectedCount === 1 ? "" : "s"] })] }), (0,jsx_runtime.jsxs)("div", { className: "bulk-action-row", children: [(0,jsx_runtime.jsx)("button", { className: "btn primary", onClick: onScrapeVisible, disabled: disabled, children: busy === "visible"
                            ? "Scraping visible…"
                            : `Scrape ${detectedCount} visible` }), (0,jsx_runtime.jsx)("button", { className: "btn", onClick: onScrapePaginated, disabled: disabled, title: limits
                            ? `Walks every page in your current filter set; capped at ${limits.maxJobs} jobs / ${limits.maxPages} pages.`
                            : `Walks every page in your current filter set.`, children: busy === "paginated" ? "Scraping all…" : "Scrape all" })] }), !busy && limits && ((0,jsx_runtime.jsxs)("p", { className: "bulk-limits", children: ["Up to ", limits.maxJobs, " jobs \u00B7 ", limits.maxPages, " pages", onOpenOptions && ((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [" · ", (0,jsx_runtime.jsx)("button", { type: "button", className: "link inline-link", onClick: onOpenOptions, children: "Adjust" })] }))] })), busy && ((0,jsx_runtime.jsxs)("div", { className: "bulk-progress", children: [(0,jsx_runtime.jsx)("p", { className: "inline-note bulk-progress-summary", children: progress ? formatProgressLine(busy, progress) : "Starting…" }), progress?.lastTitle && ((0,jsx_runtime.jsx)("p", { className: "inline-note bulk-progress-title clip", title: progress.lastTitle, children: progress.lastTitle })), onCancel && ((0,jsx_runtime.jsx)("button", { className: "btn ghost tight bulk-progress-stop", onClick: onCancel, children: "Stop" }))] })), lastResult && ((0,jsx_runtime.jsxs)("div", { className: "bulk-result", children: [(0,jsx_runtime.jsxs)("p", { className: "inline-note", children: ["Imported ", lastResult.imported, "/", lastResult.attempted, lastResult.pages > 1 && ` · ${lastResult.pages} pages`, lastResult.duplicateCount
...
function App() {
    ...
    const [scrapeLimits, setScrapeLimits] = (0,react.useState)(null);
    ...
    (0,react.useEffect)(() => {
        ...
        (async () => {
            try {
                const resp = await (0,messages/* sendMessage */._z)(messages/* Messages */.B2.getSettings());
                if (!cancelled &&
                    resp.success &&
                    resp.data &&
                    typeof resp.data.scrapeMaxJobs ===
                        "number") {
