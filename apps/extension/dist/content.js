...
class FieldDetector {
    ...
    detectUploadFields(form) {
        const uploads = [];
        const inputs = form.querySelectorAll('input[type="file"]');
        for (const element of inputs) {
            if (this.shouldSkipUploadElement(element))
                continue;
            const signals = this.gatherSignals(element);
            const kind = detectDocumentUploadKind(signals);
            if (kind === "unknown" && !looksLikeDocumentUpload(signals))
                continue;
            uploads.push({
                element,
                kind,
    ...
    shouldSkipUploadElement(element) {
        const style = window.getComputedStyle(element);
        if (style.display === "none" || style.visibility === "hidden") {
            return true;
        }
...
function detectDocumentUploadKind(signals) {
    const text = [
        signals.name,
        signals.id,
        signals.label,
...
function looksLikeDocumentUpload(signals) {
    ...
    async fillForm(fields, options = {}) {
        ...
        for (const field of fields) {
            try {
                ...
                const wouldOverwriteExisting = hadExistingValue &&
        ...
        if (element instanceof HTMLInputElement) {
            ...
            if (type === "radio") {
                const selected = element.name
                    ? document.querySelector(`input[type="radio"][name="${cssEscape(element.name)}"]:checked`)
                    : element.checked
                        ? element
                        : null;
    ...
    hasMeaningfulExistingValue(element) {
        ...
        if (element instanceof HTMLInputElement) {
            ...
            if (type === "radio") {
                if (!element.name)
                    return element.checked;
                return Boolean(document.querySelector(`input[type="radio"][name="${cssEscape(element.name)}"]:checked`));
            }
        }
        return element.value.trim().length > 0;
    }
    valuesEquivalent(element, current, suggested) {
        ...
        if (element instanceof HTMLInputElement) {
            ...
            if (type === "radio") {
                ...
                return (normalizeValue(selected.value) === normalizedSuggested ||
...
function parseBooleanSuggestion(value) {
...
function JobPageSidebar(props) {
    ...
    const [autoFillConflicts, setAutoFillConflicts] = (0,react.useState)(0);
    ...
    async function runAction(action, callback) {
        ...
        try {
            ...
            if (action === "autoFill" && fillResult) {
                ...
                const conflictCopy = conflicts > 0
...
class JobPageSidebarController {
    ...
    render() {
        ...
        root.render((0,jsx_runtime.jsx)(JobPageSidebar, { scrapedJob: this.state.scrapedJob, detectedFieldCount: this.state.detectedFieldCount, detectedUploadCount: this.state.detectedUploadCount, latestResume: this.state.latestResume, score: score, layout: this.layout, onLayoutChange: (updates) => {
                void this.updateLayout(updates);
            }, onDismiss: () => this.dismissDomain(), onTailor: this.state.onTailor, onCoverLetter: this.state.onCoverLetter, onSave: this.state.onSave, onAutoFill: this.state.onAutoFill, onOpenLatestResume: this.state.onOpenLatestResume, onSearchAnswers: this.state.onSearchAnswers, onApplyAnswer: this.state.onApplyAnswer, onChatStream: this.state.onChatStream, onUseInCoverLetter: this.state.onUseInCoverLetter }));
    }
...
async function scanPage() {
    ...
    let nextDetectedFields = [];
    let nextDetectedUploads = [];
    ...
    await sidebarController.update({
        ...
        onOpenLatestResume: async () => {
            ...
            const resumeParam = latestResume
                ...
                : "";
            window.open(`${base.replace(/\/$/, "")}/en/studio${resumeParam}`, "_blank", "noopener,noreferrer");
        },
...
async function loadLatestResumeForSidebar() {
    if (detectedUploadFields.length === 0)
        return null;
    try {
...
async function streamChat(params) {
    ...
    return new Promise((resolve, reject) => {
        ...
        try {
            ...
            reject(new Error((0,error_messages/* messageForError */.p3)(error)));
            return;
        }
        let settled = false;
        const finish = (err) => {
        ...
        try {
            ...
            finish(new Error((0,error_messages/* messageForError */.p3)(error)));
        }
    });
}
/**
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,