...
import { OpportunityResearchTab } from "@/components/opportunities/research-tab";
...
export default function OpportunityDetailPage({
  ...
  const [activeTab, setActiveTab] = useState<OpportunityTabKey>("details");
